...
a) Write a statement with _logical_ operators that compares the objects `number`, `character`, and `true` and returns `TRUE`.
b) Write a statement with _logical_ operators that compares the objects `true`, `false`, and `character` and returns `FALSE`.
c) Write a statement with _logical_ operators that compares the objects `character`, `number`, and `false` and returns `FALSE`.
