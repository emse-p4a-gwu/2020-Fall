...
Quizzes              | 15%    | 6  x 3% each; lowest is dropped
Midterm Exam         | 12%    |
Final Exam           | 20%    |
Participation        | 5%     |
</div>
...
- Due dates are flexible; if you submit an assignment, it will be graded (up until Oct. 20 for homeworks 1-6, and Dec. 8 for homeworks 7-12).

## Late Policy

Individual assignment due dates are flexible, but the longer you wait to complete each assignment, the poorer you'll likely do on quizzes and exams. 
...
In addition, all class periods will be recorded and posted on blackboard. While you are encouraged to stream or download the recordings for personal use, you are not permitted to post or share the recordings with others since the recordings will contain personally identifiable information.
