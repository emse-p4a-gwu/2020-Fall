...
---
```{r child = here::here('parts', '1-making-vectors.Rmd')}
```

---
```{r child = here::here('parts', '2-vector-operations.Rmd')}
```
...
---
```{r child = here::here('parts', '3-slicing-vectors.Rmd')}
```

---
```{r child = here::here('parts', '4-comparing-vectors.Rmd')}
```

---
```{r child = here::here('parts', '5-lists.Rmd')}
```
