...
Write the function `guessAnimal(hasFourLegs, climbsTrees)` that prints out a guess of an animal based on whether it has four legs and whether it climbs trees. Here is the expected behavior:
