...
As always, we're going to use an R project to keep everything in this assignment tidy. Download and use [this template](hw_templates/hw3.zip) for your assignment. Inside the "hw3" folder, open and edit the R script called "hw3.R" and fill out your name, GW Net ID, and the names of anyone you worked with on this assignment.
